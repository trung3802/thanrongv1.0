...
namespace TienKiemV2Remastered.Application.Constants
{
    ...
    {
        public static string newGame = "Chào mừng {0} đến với Thần Rồng!\nMình là {1} sẽ đồng hành cùng bạn ở thế giới này.";
        public static string MessageLoginGame = "Chào mừng {0} đến với Thần Rồng!\nHãy ủng hộ Thần Rồng bằng cách mở thành viên để duy trì server nhé.";
