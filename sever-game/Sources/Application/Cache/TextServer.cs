...
namespace TienKiemV2Remastered.Application.Constants
{
    public class TextServer
    {
        ...
        public readonly string LOCK_LOGIN = "Vui lòng đăng ký tài khoản tại web để vào game";
        public readonly string NOT_ACTIVE = "Tài khoản của bạn chưa được kích hoạt\nIb admin ở box zalo để kích hoạt tài khoản free tài khoản đầu.";
        ...
        public readonly string NOT_ENOUGH_KI_DISCIPLE = "Sư phụ ơi, con hết KI mất rùi";
        ...
        public readonly string PHA_LE_TRANG_BI = "{0} ô Sao pha lê";
        ...
        public readonly string PHA_LE_TRANG_BI_5 = "Nâng cấp\n{0} ngọc\nx{1} lần";
        public readonly string NOTCL = "Bạn không thể đặt cược vì không phải thành viên chính thức";
        ...
        public readonly string NAP_VANG = "Hãy truy cập web để xem hướng dẫn nạp thêm VNĐ rồi quay lại đây nhé.";
        ...
        public readonly string UPGRADE_TO_PREMIUM = "Xin chúc mừng bạn đã là thành viên chính thức của Ngọc Rồng ";
        ...
        public readonly List<string> BOSS_CHAT_TRANG = new List<string>() { "Trang của Thầy Bảo đâu ờiii!", "Năm nay ôm trụ thay vì người yêu hả ta?", "FA, Buồn quá trời :<<" };
        ...
        public readonly List<string> TRONG_TAI = new List<string>() {"Đại hội võ thuật\nthế giới là một giải đấu uy\ntín bậc nhất" };
        ...
        public readonly string GET_GOLD_BAR1 = "Bạn đã nhận được {0} hồng ngọc";
        ...
        public readonly List<string> CHAT_SEXY = new List<string>(){"Cô nương này sao đẹp thế !!!!", "Này này này là em gì ơi, em gì ới, em gì ơi"};
        public readonly List<string> CHAT_FOR_MAI = new List<string>() { "2 3 con mực\nanh yêu em cực", "3 chai tăng lực\nyêu em căng cực", "Ú òa \nMình chỉ là một người đến sau:(", "Nghèo thì phải sạch mà rách thì SEXY", "Vì mình quá thích cậu rồi, \nphải làm sao phải làm sao?", "Bắp luộc đê?!!" };
