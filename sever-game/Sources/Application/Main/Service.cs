    ...
    public class Service
    {
        ...
        public static Message LuckRoll0()
        {
            try
            {
                ...
                message.Writer.WriteInt(DataCache.CRACK_BALL_PRICE); // giá
        ...
        public static Message Disciple(int type, Disciple disciple)
        {
            try
            {
                ...
                message.Writer.WriteByte(5); //skill
                for (var i = 0; i < 5; i++)
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            message.Writer.WriteUTF(i switch
                            {
                                ...
                                4 => "Mở khóa khi đạt 80 Tỷ sức mạnh",
        ...
        public static Message ItemTimeWithMessage(string text, int itemId, int time)
        {
            try
            {
        ...
        //-99 _ Me
        public static Message ListEmeny(Character character,IEnumerable<InfoFriend> list)
        {
            try
            {
                ...
                newList.ForEach(emeny =>
                {
                    ...
                    if (int.Parse(character.Player.Session.Version.Replace(".","")) > 214){
                    message.Writer.WriteShort(0);
                    }
        ...
        public static Message StartVerusDHVT(Character p, Character pvs, byte type)
        {
            var message = new Message(-30);
            message.Writer.WriteByte((byte)35);
            message.Writer.WriteInt(p.Id);
            message.Writer.WriteByte(type);
            return message;
        }
        //-96 _ Me
        public static Message ListRank(Character character, String RankName)
        {
            try
            {
                ...
                message.Writer.WriteByte(0);
                message.Writer.WriteUTF(RankName);
                message.Writer.WriteByte(100);
                for (int i = 0; i < 100; i++)
                {
                    message.Writer.WriteInt(i + 1);
                    ...
                    message.Writer.WriteUTF("Đẹp Trai Nhất Vũ Trụ");
                    message.Writer.WriteUTF("Đẹp Trai Nhất Vũ Trụ");
                }
                return message;
            }
        ...
        //public void sendTabTop(Player pl, String topname, Vector<TopInfo> tops)
        //{
        //    Message msg = null;
        //    try
        //    {
        ...
        //            msg.writer().writeUTF(tops.get(i).info2);
        //        }
        //        pl.sendMessage(msg);
        //    }
        //    catch (Exception e)
        ...
        public static Message UpdateCooldown(ICharacter character)
        {
            try
            {
                ...
                character.Skills.ForEach(skill =>
                {
                    ...
                    message.Writer.WriteInt(timeLast - 1000);
                });
                return message;
            }
            catch (Exception e)
        ...
        public static Message SendNewBackground()
        {
            try
            {
                var bytes = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(DatabaseManager.ConfigManager.gI().NewBG));
        ...
        public static Message UpdateData()
        {
            try
            {
                ...
                //byte[] part = System.IO.File.ReadAllBytes("");
                message.Writer.WriteByte(DatabaseManager.ConfigManager.gI().DataVersion);
                
                if (!DatabaseManager.ConfigManager.gI().IsDir)
                {
                ...
                {
                    var bytes = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(DatabaseManager.ConfigManager.gI().NR_Dart));
                    message.Writer.WriteInt(bytes.Length);
                    message.Writer.Write(bytes);
                
                    bytes = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(DatabaseManager.ConfigManager.gI().NR_Arrow));
                    message.Writer.WriteInt(bytes.Length);
                    message.Writer.Write(bytes);
                
                    bytes = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(DatabaseManager.ConfigManager.gI().NR_Effect));
                    message.Writer.WriteInt(bytes.Length);
                    message.Writer.Write(bytes);
                
                    bytes = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(DatabaseManager.ConfigManager.gI().NR_Image));
                    message.Writer.WriteInt(bytes.Length);
                    message.Writer.Write(bytes);
                
                    bytes = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(DatabaseManager.ConfigManager.gI().NR_Part));
                    message.Writer.WriteInt(bytes.Length);
                    message.Writer.Write(bytes);
                
                    bytes = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(DatabaseManager.ConfigManager.gI().NR_Skill));
                    message.Writer.WriteInt(bytes.Length);
                    message.Writer.Write(bytes);
                }
                return message;
        ...
        //-86 _ 6 _ ME
        public static Message Trade6(int version, List<Item> items)
        {
            try
            {
                var message = new Message(-86);
        ...
        public static Message SendTileSet()
        {
            try
            {
                var fileName = ServerUtils.ProjectDir(DatabaseManager.ConfigManager.gI().TileMap);
        ...
        //-81 _ ME
        public static Message SendCombinne0(List<string> info, int npcId = 21)
        {
            try
            {
        ...
        public static Message SendCombinne6(short iconId1, short iconId2, short npcId = 21)
        {
            try
            {
                var message = new Message(-81);
        ...
        public static Message SendCombinne7(short iconIdWhenSucces, short npcId = 21) // tất cả item trong itemvcombine bay vòng vòng xong thành công ra icon success đã send short id 
        {
            try
            {
                var message = new Message(-81);
                message.Writer.WriteByte(7);
                message.Writer.WriteShort(iconIdWhenSucces);
                message.Writer.WriteShort(npcId);
                return message;
            }
            catch (Exception e)
        ...
        public static Message HideNpc(byte idNpc, bool isHide = false)
        {
            var msg = new Message(-73);
            msg.Writer.WriteByte(idNpc);
            msg.Writer.WriteByte(isHide ? 0 : 1); // 0 là ẩn 1 là hiện 
            return msg;
        }
        //-80 _ ME
        public static Message ListFriend0(int ver,List<InfoFriend> list)
        {
            try
            {
                ...
                list.ForEach(friend =>
                {
                    ...
                    message.Writer.WriteUTF((friend.Name != null ? friend.Name : "UNKNOW"));
        ...
        public static Message GetImageResource()
        {
            try
            {
                ...
                message.Writer.WriteByte(0);
                message.Writer.WriteInt(DatabaseManager.ConfigManager.gI().DownloadVersion);
                return message;
            }
            catch (Exception e)
            {
        ...
        public static Message SendImageResource1(int zoomLevel)
        {
            ...
            try
            {
                var path = ServerUtils.ProjectDir(string.Format(DatabaseManager.ConfigManager.gI().Download, zoomLevel));
        ...
        public static void SendImageResource2(ISession_ME session)
        {
            if (session.ZoomLevel is < 1 or > 4) session.ZoomLevel = 2;
            var path = ServerUtils.ProjectDir(string.Format(DatabaseManager.ConfigManager.gI().Download, session.ZoomLevel));
            var dir = new DirectoryInfo(path).GetFiles().ToList();
            var listDir = CollectionsMarshal.AsSpan(dir);
            var pathName = "bg";
        ...
        public static Message PlusGold(Character character, int gold)
        {
            var msg = new Message(95);
            msg.Writer.WriteInt(gold);
            return msg;
        }
        public static Message PlusDiamond(Character character, int gem)
        {

            var msg = new Message(-1);
            msg.Writer.WriteInt(gem);
            return msg;
        }
        public static Message StealMoney(int money)
        {
            var msg = new Message(6);
            msg.Writer.WriteInt(money);
            return msg;
        }
        //-70
        public static Message BigMessage()
        {
            try
            {
                ...
                message.Writer.WriteUTF("Chào mừng bạn đến với NRO TARA");
                message.Writer.WriteByte(0);
                return message;
            }
            catch (Exception e)
        ...
        public static Message BigMessage(string text)
        {
            try
            {
                var message = new Message(-70);
        ...
        //-66
        public static Message SendEffect(int version,int zoomLevel, short id, short idTemp, int setDragon)
        {
            int idT = id;
            if (idTemp == 25)
            {
                ...
                if (setDragon == 1) // vo cuc
                {
                    idT = 50;
                }else if (setDragon == 2)// rong xuong
                {
                    idT = 51;
                }
                else if (setDragon == 3) // rong bang
                {
                    idT = 59;
                }else if (setDragon == 4) // rong den with electric
                {
                    idT = 60;
                }
                else
                {
                    idT = 61; // rong den without electric
                }
            }
            ...
            try
            {
                ...
                var bytes = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(string.Format(DatabaseManager.ConfigManager.gI().EffectData, zoomLevel, idT)));
                var bytes2 = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(string.Format(DatabaseManager.ConfigManager.gI().EffectImg, zoomLevel, idT)));
                var message = new Message(-66);
                message.Writer.WriteShort(idT);
                message.Writer.WriteInt(bytes.Length);
                message.Writer.Write(bytes);
                if(version >= 218)
                {
        ...
        public static Message SendEffect2(int zoomLevel, short id)
        {
            if (zoomLevel < 1 || zoomLevel > 4) zoomLevel = 2;
            try
            {
                var bytes = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(string.Format(DatabaseManager.ConfigManager.gI().EffectData, zoomLevel, id)));
                var bytes2 = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(string.Format(DatabaseManager.ConfigManager.gI().EffectImg, zoomLevel, id)));
                var message = new Message(-66);
                message.Writer.WriteShort(id);
                message.Writer.WriteInt(bytes.Length);
                message.Writer.Write(bytes);
        ...
        public static Message SendEffChar(byte loop, byte layer, byte id, short x, short y, short loopCount)
        {
            try
            {
                ...
                msg.Writer.WriteByte(id); // id
                msg.Writer.WriteShort(x); // x
                msg.Writer.WriteShort(y); // y
                msg.Writer.WriteShort(loopCount); // loopCount
        ...
        public static Message MyClanInfo(Character character)
        {
            try
            {
                ...
                if (character.ClanId != -1 || character.ClanId > -1)
                {
                    ...
                    message.Writer.WriteUTF(clan.Khẩu_hiệu);
                    message.Writer.WriteByte(clan.ImgId);
                    message.Writer.WriteUTF(ServerUtils.GetPower(clan.Điểm_thành_tích)); // power point
             //       message.Writer.WriteUTF("10");
                    message.Writer.WriteUTF(clan.LeaderName);
                    message.Writer.WriteByte(clan.Thành_viên.Count);
                    message.Writer.WriteByte(clan.Tối_đa_thành_viên);
                    message.Writer.WriteByte(memberChar.Role);//role
                    message.Writer.WriteInt(clan.Capsule_Bang);// clan point
                    message.Writer.WriteByte(clan.Cấp_Độ);
                    clan.Thành_viên.ToList().ForEach(member =>
                    {
                        ...
                        message.Writer.WriteInt(member.Cho_đậu); // clan pount
                        message.Writer.WriteInt(member.Nhận_đậu);
                        message.Writer.WriteInt(member.Capsule_Bang);
                        message.Writer.WriteInt(member.Capsule_Cá_Nhân);
        ...
        public static Message AddMemberClan(ClanMember member)
        {
            try
            {
                ...
                message.Writer.WriteByte(member.Role);
                message.Writer.WriteUTF(ServerUtils.GetPower(member.Power));//role
                message.Writer.WriteInt(member.Cho_đậu);
                message.Writer.WriteInt(member.Nhận_đậu);
                message.Writer.WriteInt(member.Capsule_Bang);
                message.Writer.WriteInt(member.JoinTime);
                return message;
        ...
        // 47 _ ME
        public static Message LockInventory(Character character)
        {
            var m = new Message(47);
            return m;
        }
        //-47 _ ME
        public static Message ClanSearch(List<Clan> clans)
        {
            try
            {
                ...
                clans.ForEach(clan =>
                {
                    ...
                    message.Writer.WriteUTF(clan.Khẩu_hiệu);
                    message.Writer.WriteByte(clan.ImgId);
                    message.Writer.WriteUTF(ServerUtils.GetPower(clan.Điểm_thành_tích));
                    message.Writer.WriteUTF(clan.LeaderName);
                    message.Writer.WriteByte(clan.Thành_viên_hiện_tại);
                    message.Writer.WriteByte(clan.Tối_đa_thành_viên);
                    message.Writer.WriteInt(clan.Thời_gian_tạo_bang);
                });
                return message;
            }
            catch (Exception e)
...
public static Message SkillNotFocus20(int charId, int id, byte typeFrame, short timeGong, byte isFly, byte dir = 1) // khi gồng xong
        {
            try
            {
                var message = new Message(-45);
                ...
                message.Writer.WriteInt(charId);
                message.Writer.WriteShort(id);
                message.Writer.WriteByte(typeFrame); // type frame || 1 la super kamejoko || 2 la super galick gun || 3 la ma phong ba
                message.Writer.WriteByte(dir); // dir
                message.Writer.WriteShort(timeGong);
                message.Writer.WriteByte(isFly); // == 1 true ? false
                message.Writer.WriteByte(0); // type paint || 0 la từ client 2.3.1 còn lại là 1 sendImgByName của client thấp
                message.Writer.WriteByte(0); // type item
                return message;
            }
            catch (Exception e)
            {
        ...
        public static Message SkillNotFocus21(int charId,int skillId,short x, short y, short timeAttack, short RangeAttack, List<ICharacter> characters, int monsters) // chưởng
        {
            try
            {
                var message = new Message(-45);
                ...
                message.Writer.WriteShort(timeAttack); // time
                message.Writer.WriteShort(RangeAttack); // range
                message.Writer.WriteByte(0); // type paint
                message.Writer.WriteByte(0); // số thực thể trong range dame
                if (skillId == 26){
                ...
                for (int i2 = 0; i2 < characters.Count;i2++){
                    message.Writer.WriteByte(1);
                   message.Writer.WriteInt(characters[i2].Id);
                }
                }
                message.Writer.WriteByte(0); // type item
                return message;
         ...
         public static Message SkillNotFocus21(int charId,int skillId,short x, short y, short timeAttack, short RangeAttack, Character character) // chưởng
        {
            try
            {
                var message = new Message(-45);
                ...
                message.Writer.WriteShort(RangeAttack); // range
                message.Writer.WriteByte(0); // type paint
                message.Writer.WriteByte(character.Zone.MonsterMaps.Count + character.Zone.Characters.Count + character.Zone.Bosses.Count); // số thực thể trong range dame
                if (skillId == 26){
                for (int i = 0; i < character.Zone.MonsterMaps.Count;i++){
                        var mob = character.Zone.MonsterMaps[i];
                   var check = mob.X > x ? Math.Abs(mob.X - x) <= RangeAttack : Math.Abs(x - mob.X) <= RangeAttack;
                   message.Writer.WriteByte(0);
                   message.Writer.WriteByte(i);
                        character.InfoSkill.MaPhongBa.IdMonsterMaps.Add(i);
                }
                for (int i2 = 0; i2 < character.Zone.Characters.Count;i2++){
                        var @char = character.Zone.ZoneHandler.CharacterInMap()[i2];
                    var check = @char.InfoChar.X >= x ? Math.Abs(@char.InfoChar.X - x) <= RangeAttack : Math.Abs(x- @char.InfoChar.X) <= RangeAttack;
                        if (check)
                        {
                            message.Writer.WriteByte(1);
                            message.Writer.WriteInt(@char.Id != character.Id ? @char.Id : -1);
                            if (@char.Id != character.Id) character.InfoSkill.MaPhongBa.IdCharacters.Add(@char.Id);
                        }
                }
                for (int i3 =0 ; i3 < character.Zone.Bosses.Count;i3++){
                    var boss = character.Zone.ZoneHandler.BossInMap()[i3];
                    var check = boss.InfoChar.X >= x ? Math.Abs(boss.InfoChar.X - x) <= RangeAttack : Math.Abs(x- boss.InfoChar.X) <= RangeAttack; 
                    message.Writer.WriteByte(1);
                    message.Writer.WriteInt(check ? boss.Id : -1);
                        if (check)  character.InfoSkill.MaPhongBa.IdBosses.Add(boss.Id);
                }
            }
                message.Writer.WriteByte(0); // type item
                return message;
                    ...
                    case 0:
                    {
                        shopTemplates.ForEach(shop =>
                        {
                            ...
                            shop.ItemShops.ForEach(item =>
                            {
                                ...
                                message.Writer.WriteInt(item.Vang * percent);
                                ...
                                if (itemTemplate.IsTypeBody())
                                {
                                    ...
                                    {
                                        if (ItemCache.IsAvatar(item.HeadTemp))
                                        {
                    ...
                    case 3:
                        {
                            shopTemplates.ForEach(shop =>
                            {
                                ...
                                shop.ItemShops.ForEach(item =>
                                {
                                    ...
                                    message.Writer.WriteShort(iditem);
                                    message.Writer.WriteShort(item.Ngoc);
                                    message.Writer.WriteInt(item.Vang);
        ...
        public static Message SubBox(List<Item> items)
        {
         ...
         public static void EndcodeBase64(System.Text.Encoding end,string text)
        {
            Server.Gi().Logger.Print(getStringBase64(end, text), "red");
        }
        public static string getStringBase64(System.Text.Encoding end,string text)
        {
            return System.Convert.ToBase64String(end.GetBytes(text));
        }
        public static Message ClanBox(List<Item> items)
        {
            Message message;
            try
            {
        ...
        public static Message SendBag2(ICharacter character)
        {
            character.CharacterHandler.BagSort();
            Message message;
            try
            {
                ...
                message.Writer.WriteByte(character.BagLength());
                ItemTemplate itemTemplate;
                Span<Item> itemBags = CollectionsMarshal.AsSpan(character.ItemBag);
        ...
        public static Message SendBgImg(int zoomLevel, short id)
        {
            try
            {
                var path = ServerUtils.ProjectDir(string.Format(DatabaseManager.ConfigManager.gI().BackgroundImg, zoomLevel, id));
        ...
        public static Message UpdateSkill0(short id, short currExp)
        {
            try
            {
                var message = MessageSubCommand(62);
                message.Writer.WriteShort(id);
                message.Writer.WriteByte(0);
                message.Writer.WriteShort(currExp); // 0 -> 1000
                return message;
            }
            catch (Exception e)
            {
        ...
        public static Message UpdateSkill1(short id, short currExp)
        {
            try
            {
                var message = MessageSubCommand(62);
        ...
        public static Message UpdateTypePK(Character c, byte type)
        {
            var message = new Message(-30);
            message.Writer.WriteByte((byte)35);
            message.Writer.WriteInt(c.Id);
        ...
        public static Message PlayerLoadAll(ICharacter character, string text = "")
        {
            ...
            try
            {
                ...
                message.Writer.WriteSByte(character.InfoChar.idEff_Set_Item);
                message.Writer.WriteShort(character.InfoChar.idHat);
                return message;
            }
            catch (Exception e)
            {
        ...
        public static Message BachTuoc()
        {
        ...
        public static Message MeLoadAll(ICharacter character)
        {
            try
            {
                ...
                message.Writer.WriteInt(character.Id);
                message.Writer.WriteByte(character.InfoTask.Id);
                message.Writer.WriteByte(character.InfoChar.Gender);
                message.Writer.WriteShort(character.GetHead());
        ...
        public static Message ServerList()
        {
            try
            {
                ...
                message.Writer.WriteUTF(DatabaseManager.ConfigManager.gI().Link);
                message.Writer.WriteByte(1);
                return message;
            }
            catch (Exception e)
        ...
        public static Message UpdateItem(int type)
        {
            try
            {
                ...
                message.Writer.WriteByte(DatabaseManager.ConfigManager.gI().ItemVersion);
                message.Writer.WriteByte(type);
                switch (type) {
                    case 0: {
        ...
        public static Message SendDanhHieu(int characId,short smaillId, int frame)
        {
            var message = new Message(-128);
            message.Writer.WriteInt(characId);
            message.Writer.WriteShort(smaillId);
            message.Writer.WriteInt(frame);
            return message;
        }
        //-28_7
        public static Message UpdateSkill()
        {
            try
            {
                ...
                // {
                // }
                //var bytes = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(DatabaseManager.ConfigManager.gI().NRskill));
                message.Writer.Write(Cache.Gi().NRSKILL);
                //message.Writer.Write(bytes);
        ...
        public static Message UpdateMap()
        {
            try
            {
                ...
                {
                    var bytes = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(DatabaseManager.ConfigManager.gI().NRmap)); 
                    message.Writer.Write(bytes);
                } 
        ...
        public static Message SendVersionMessage()
        {
            try
            {
                ...
                message.Writer.WriteByte(DatabaseManager.ConfigManager.gI().DataVersion);
                message.Writer.WriteByte(DatabaseManager.ConfigManager.gI().MapVersion);
                message.Writer.WriteByte(DatabaseManager.ConfigManager.gI().SkillVersion);
                message.Writer.WriteByte(DatabaseManager.ConfigManager.gI().ItemVersion);
                message.Writer.WriteByte(1);
        ...
        public static Message MessagePickItem(string alert)
        {
            try
            {
                var message = new Message(-25);
                message.Writer.WriteUTF("Chúc mừng bạn đã nhặt được " + alert);
                return message;
            }
            catch (Exception e)
            {
        ...
        public static Message CallDragon(ICharacter character)
        {
            try
            {
                var message = new Message(-83);
                ...
                message.Writer.WriteShort(character.InfoChar.X);
                message.Writer.WriteShort(character.InfoChar.Y);
                message.Writer.WriteByte(1); //0 thường, 1 namek
                return message;
            }
            catch (Exception e)
            {
        ...
        public static Message CallDragon(ICharacter character, int typeDragon)
        {
            character.TypeDragon = typeDragon;
            try
            {
                var message = new Message(-83);
                message.Writer.WriteByte(0); //0 = gọi, 1 = ẩn
        ...
        public void setImageDuaHau(int second)
        {
            if (second <= DataCache._1DAYBYSECOND / 4)
            {
                // 4672
            }
            else if (second <= DataCache._1DAYBYSECOND / 3)
            {
                // 4671
            }else if (second <= DataCache._1DAYBYSECOND /2)
            {
                // 4670
            }else if (second <= DataCache._1DAYBYSECOND )
            {
                // 4669
            }
        }
        ...
        public static Message DuaHau(ICharacter character)
        {
            var seconds = (character.InfoChar.ThoiGianDuaHau - ServerUtils.CurrentTimeMillis()) / 1000;
            if (seconds < 0)
            {
                seconds = 0;
            }
            ...
            {
                var message = new Message(-122);
                message.Writer.WriteShort(51); //id quả trứng
                message.Writer.WriteByte(1); // số lượng trứng
                message.Writer.WriteShort(image); //ảnh của trứng
                message.Writer.WriteByte(0);// index qủa trứng
                message.Writer.WriteInt((int)seconds);//thời gian trứng nở
                return message;
            }
        ...
        public static Message MapInfo(Zone zone, ICharacter character)
        {
            ...
            try
            {
                ...
                //Monster
                int plusMob = 0;
                //var gautuongcuop = false;
                //if (ThiefBear.gI().CurrentMapsSpawn == character.InfoChar.MapId && ThiefBear.gI().CurrentZonesSpawn == character.Zone.Id) ;
                //{
                //    plusMob += 1;
                //    gautuongcuop = true;
                //}
                message.Writer.WriteByte(zone.MonsterMaps.Count+plusMob);
                //if (gautuongcuop)
                //{
                ...
                //    message.Writer.WriteBoolean(false);
                //    message.Writer.WriteBoolean(false);
                //    message.Writer.WriteByte(77);
                //    message.Writer.WriteByte(0);
                //    message.Writer.WriteInt((int)2000000000);
                //    message.Writer.WriteByte(20);
                //    message.Writer.WriteInt(1000000);
                //    switch (character.InfoChar.MapId)
                //    {
                //        case 3:
                //            message.Writer.WriteShort(1247);
                //            message.Writer.WriteShort(336);
                //            break;
                //        case 27:
                //            message.Writer.WriteShort(881);
                //            message.Writer.WriteShort(336);
                //            break;
                //        case 28:
                //            message.Writer.WriteShort(989);
                //            message.Writer.WriteShort(264);
                //            break;
                //        case 4:
                //            message.Writer.WriteShort(454);
                //            message.Writer.WriteShort(336);
                //            break;
                //    }
                ...
                zone.MonsterMaps.ForEach(monster =>
                {
                    ...
                    if (monster.Id == 70)
                    {
                        message.Writer.WriteByte(monster.TypeHidru);
                    }
                    else
                    {
                ...
                if (charRel.InfoChar.MapId - 21 == charRel.InfoChar.Gender)
                {
                    ...
                    if (charRel.InfoChar.ThoiGianDuaHau > 0) //Có trứng ma bư
                    {
                        addCountNpc += 1;
                        hasDuaHau = true;
                    }
                }
                //if (Application.Extension.Event.EventRuntime.MapInitNpc.Contains(charRel.InfoChar.MapId))
                //{
                //    if (Application.Extension.Event.EventRuntime.GetZoneInitNpc(charRel.InfoChar.MapId) == charRel.Zone.Id)
                //    {
                //        addCountNpc += 1;
                //        hasVuaHung = true;
                //    }
                //}
                //if (charRel.InfoChar.MapId == 111)
                //{
                //    addCountNpc += 1;
                //    haclong = true;
                // //   thanhlong = true;
                ...
                {
                    message.Writer.WriteByte((byte)0);
                    message.Writer.WriteShort(charRel.DuaHauPosition.X);
                    message.Writer.WriteShort(charRel.DuaHauPosition.Y);
                    message.Writer.WriteByte((byte)51);
                    message.Writer.WriteShort(0);
                }
                if (hasVuaHung)
                {
                    ...
                    if (tileMap.Id == 3)
                    {
                        message.Writer.WriteShort(640);
                        message.Writer.WriteShort(408);
                    }else if (tileMap.Id == 27)
                    {
                        message.Writer.WriteShort(756);
                        message.Writer.WriteShort(336);
                    }
                    else if (tileMap.Id == 28)
                    {
                        message.Writer.WriteShort(684);
                        message.Writer.WriteShort(312);
                    }
                    else if (tileMap.Id == 29)
                    {
                        message.Writer.WriteShort(1034);
                        message.Writer.WriteShort(360);
                    }
                    else if (tileMap.Id == 6)
                    {
                        message.Writer.WriteShort(485);
                        message.Writer.WriteShort(336);
                    }
                    else if (tileMap.Id == 4)
                    {
                        message.Writer.WriteShort(641);
                        message.Writer.WriteShort(360);
                    }
                    message.Writer.WriteByte((byte)52);
                    message.Writer.WriteShort(0);
                }
                if (haclong)
                {
                    message.Writer.WriteByte((byte)0);
                    message.Writer.WriteShort(749);
                    message.Writer.WriteShort(336);
                    message.Writer.WriteByte((byte)50);
                    message.Writer.WriteShort(0);
                }
                ...
                //{
                //    message.Writer.WriteByte((byte)0);
                //    message.Writer.WriteShort(1051);
                //    message.Writer.WriteShort(336);
                //    message.Writer.WriteByte((byte)79);
                //    message.Writer.WriteShort(0);
                //}
        ...
        //-9  _ Zone
        public static Message MonsterHp(IMonster monster, bool isCrit, int damage, int effId)
        {
            try
            {
                ...
                message.Writer.WriteByte(effId); //Hiệu ứng đòn đánh
                return message;
            }
            catch (Exception e)
            {
        ...
        public static Message PlayerAdd(ICharacter character, string text = "")
        {
            ...
            try
            {
                ...
                if (ClanManager.Get(character.ClanId) != null && character.ClanId != -1 && character.ClanId != -100 && ClanManager.Get(character.ClanId).shortName != "")
                {
                    message.Writer.WriteUTF($"[{ClanManager.Get(character.ClanId).shortName}]{character.Name}");
                }
                else
                {
                    message.Writer.WriteUTF($"{text}{character.Name}");
                ...
                message.Writer.WriteShort(character.InfoChar.EffectAuraId);            // aura id
        ...
        public static Message SendTask(ICharacter character)
        {
            try
            {
                var task = Cache.Gi().TASK_TEMPLATES_0.Values
                    .FirstOrDefault(t => t.Id == character.InfoTask.Id);
               ...
               .FirstOrDefault(t => t.Id == character.InfoTask.Id);
                ...
                message.Writer.WriteShort(character.InfoTask.Id);
                message.Writer.WriteByte(character.InfoTask.Index);
                ...
                {   
                    var a = Cache.Gi().TASKS.FirstOrDefault(x => x.Key == character.InfoTask.Id).Value[indexTask];
                    switch (a)
                    {
                        case 0:
                            switch (g)
                    ...
                    var b = Cache.Gi().MAPTASKS.FirstOrDefault(x => x.Key == character.InfoTask.Id).Value[indexTask];
                    switch (b)
                    {
                        case 0:
                            switch (g)
                    ...
                    message.Writer.WriteShort(b);
                    message.Writer.WriteUTF(""); // content info || task.contentInfo[index]
                    indexTask++;
                });
                message.Writer.WriteShort(character.InfoTask.Count);
                task.Counts.ForEach(count => message.Writer.WriteShort(count == 1 ? -1 : count));
                return message;
            }
            catch (Exception e)
            {
        ...
        public static Message SendImgByName(int zoomLevel, string name)
        {
            ...
            {
                var nFrame = 3;
                if (name.Contains("4_1")|| name.Contains("set_eff_4_0") || name.Contains("set_eff_5_0") || name.Contains("set_eff_6_0") || name.Contains("set_eff_7_0") || name.Contains("set_eff_8_0")) nFrame = 2; // so luong picture trong 1 picture
                else if (name.Contains("set_eff_10") || name.Contains("set_eff_11") || name.Contains("set_eff_9")) nFrame = 4;
                else if (name.Contains("7_1") || name.Contains("9_0") || name.Contains("3_1") || name.Contains("aura_0_0") || name.Contains("aura_0_1") || name.Contains("aura_3_0") || name.Contains("13_0") || name.Contains("13_1") || name.Contains("12_0") || name.Contains("12_1")) nFrame = 4;
                else if (name.Contains("aura_2_0")) nFrame = 5;
                else if (name.Contains("aura_3_0")) nFrame = 8;
                else if (name.Contains("mount_14_1")) nFrame = 7;
                else if (name.Contains("hat_truoc") || name.Contains("hat_sau")) nFrame = 6;

                var bytes = ServerUtils.ReadFileBytes(ServerUtils.ProjectDir(string.Format(DatabaseManager.ConfigManager.gI().Mount, zoomLevel, name)));
                if (bytes == null) {
        ...
        public static Message SendRank(int rank) // rank cua player trong cho skill
        {
            var msg = new Message(-119);
            msg.Writer.WriteInt(rank);
            return msg;
        }
        public static Message Register() // menu dang ky tai khoan
        {
            var msg = new Message(42);
            msg.Writer.WriteByte(0);
            return msg;
        }
        public static Message ShowYourNumber0(String text)
        {
            var msg = new Message(-126);
            msg.Writer.WriteByte(0);
            msg.Writer.WriteUTF(text);
            return msg;
        }
        public static Message ShowYourNumber1(string winNumber, string strWinNumber)
        {
            var msg = new Message(-126);
            msg.Writer.WriteByte(1);
            msg.Writer.WriteByte(0);
            msg.Writer.WriteUTF(winNumber);
            msg.Writer.WriteUTF(strWinNumber);
            return msg;
        }
        //74
        ...
        public static Message MeLoadSpeed(int Id, byte speed)
        {
            try
            {
                var message = new Message(8);
                message.Writer.WriteInt(Id);
                message.Writer.WriteByte(speed);
                return message;
            }
            catch (Exception e)
            {
        ...
        //127_1 _ ME
        public static Message Radar1(int id, int use) // bấm nút tam giác rồi action option 
        {
            try
            {
                var message = new Message(127);
        ...
        public static Message Radar4(int id,short idAura)
        {
            
            try
            {
                var m = new Message(127);
            ...
            {
                Server.Gi().Logger.Error($"Error AddEffect in Service.cs: {e.Message} \n {e.StackTrace}", e);
                return null;
            }
           
        }
        public static Message  addEff(Player player, short id, short x, short y, byte layer, byte loop, short loopCount)
        {
          //  Message msg;
            try
            {
