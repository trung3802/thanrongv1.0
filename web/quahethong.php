...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Quà hệ thống</h5>
                <div class="card">
                    <div class="card-body">
                        <table class="table">
                            ...
                            $query = "SELECT q.uid, q.code, q.thoigiannhan, g.count, g.time_expire
                                        FROM quahethong q INNER JOIN giftcodeht g ON q.code = g.code
                                        WHERE q.uid = $id";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    $content .= "<td>" . $row["thoigiannhan"] . "</td>";
