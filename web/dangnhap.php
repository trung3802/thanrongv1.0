            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    ...
                    <form id="form" action="login" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label class="mt-2 mt-2"><span class="text-danger">*</span> Mật khẩu:</label>
                            <input class="form-control mt-2" type="password" name="password" id="password"
                                placeholder="Nhập mật khẩu">
                        </div>
                        <div class="form-check form-group">
                            <label class="mt-2 mt-2" class="form-check-label">
                                <input class="form-check-input" type="checkbox" name="remember" id="remember"
                                    checked=""> Ghi nhớ
                            </label>
                            <a href="#" class="mt-2 text-dark" style="float: right;">Quên mật khẩu</a>
                        </div>
                        <div class="mt-2" id="notify" class="text-danger pb-2 font-weight-bold"></div>
                        <button class="btn btn-header form-control" id="btn" type="submit">ĐĂNG NHẬP</button>
                    </form>
                </div>
            </div>
        </div>
