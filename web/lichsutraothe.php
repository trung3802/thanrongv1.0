...
if (isset($_SESSION['id']) && isset($_SESSION['username'])) {
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table">
                            ...
                            $query = "SELECT d.username, d.character_id, d.character_ten, d.nhamang, d.menhgia, d.soluong, d.mathe, d.seri, d.thoigiantaodonhang, d.trangthai 
                                        FROM doithe d ORDER BY d.id DESC";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    $content .= "<td>" . $row["character_id"] . "</td>";
    ...
    $query = "SELECT COUNT(*) AS totalRows FROM doithe d ORDER BY d.id DESC";
    $result = mysqli_query($conn, $query);
