...
<div id="snow"></div>
    ...
    <h4 class="shop text-center">
        <script type="text/javascript" data-cfasync="false">
            ...
            farbbibliothek[2] = new Array("#824800", "#824800", "#824800", "#824800", "#824800", "#925100",
            ...
            function divserzeugen2() {
                for (var i = 0; i < Buchstabe2.length; i++) {
                    document.write("<span id='b" + i + "' class='b" + i + "'>" + Buchstabe2[i] + "<\/span>");
                }
                farbschrift2();
            }
            ...
            divserzeugen2();
                    ...
                    <div class="text-center pt-2" style="background-color: #BFEFFF">
        ...
        <div class="container pt-5 pb-5" style="background-color: #1E90FF">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    ...
                    <?php } ?>
                    <form id="form" action="signup-check" method="post" autocomplete="off">
                        <div class="form-group">
                            <label class="mt-2"><span class="text-danger">*</span> Tài khoản:</label>
                            <?php if (isset($_GET['uname'])) { ?>
                                <input class="form-control mt-2" type="text" name="uname" id="username"
                                    placeholder="Nhập tài khoản" value="<?php echo $_GET['uname']; ?>" />
                            <?php } else { ?>
                                <input class="form-control mt-2" type="text" name="uname" id="username"
                        ...
                        <div class="form-group">
                            <label class="mt-4"><span class="text-danger">*</span> Email:</label>

                            <?php if (isset($_GET['email'])) { ?>
                                <input class="form-control mt-2" type="text" name="email" id="email"
                                    placeholder="Nhập Email" value="<?php echo $_GET['email']; ?>" />
                            <?php } else { ?>
                                <input class="form-control mt-2" type="text" name="email" id="email"
                        ...
                        <div class="form-group">
                            <label class="mt-4"><span class="text-danger">*</span> Số điện thoại:</label>

                            <?php if (isset($_GET['sdt'])) { ?>
                                <input class="form-control mt-2" type="text" name="sdt" id="sdt"
                                    placeholder="Nhập số điện thoại" value="<?php echo $_GET['sdt']; ?>" />
                            <?php } else { ?>
                                <input class="form-control mt-2" type="text" name="sdt" id="sdt" maxlength="10"
                                    placeholder="Nhập số điện thoại">
                            <?php } ?>
                        </div>
                        <div class="form-group">
                            <label class="mt-4"><span class="text-danger">*</span> Mật khẩu:</label>

                            <input class="form-control mt-2" type="password" name="password" id="password"
                                placeholder="Nhập mật khẩu">
                        </div>
                        <div class="form-group">
                            <label class="mt-4"><span class="text-danger">*</span> Nhập lại mật khẩu:</label>
                            <input class="form-control mt-2" type="password" name="re_password" id="password"
                                placeholder="Nhập lại mật khẩu">
                        </div>
                        <div class="form-group">
                            <label class="mt-4"><span class="text-danger">* <i>Lưu ý: Gmail nên chính chủ để lấy lại password khi quên!</i></span></label>                   
                        </div>
                        <div class="form-check form-group mt-4">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" name="accept" id="accept" checked="">
                                Đồng ý <a href="" target="_blank">Điều khoản sử dụng</a>
                            </label>
                        </div>
                        <div class="mt-2" id="notify" class="text-danger pb-2 font-weight-bold"></div>
                        <button class="btn btn-header form-control" id="btn" type="submit">ĐĂNG KÝ</button>
                    </form>
                </div>
            </div>
        </div>
