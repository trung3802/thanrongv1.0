...
if (mysqli_num_rows($result) > 0) {
  ...
  echo "<script>alert('Nạp tiền thành công!'); window.location = '../adnaptien.php';</script>";
} else {
  // Nếu tài khoản không tồn tại, hiển thị thông báo lỗi và nút quay lại trang chủ
  echo "<script>alert('Tài khoản không tồn tại!'); window.location = '../adnaptien.php';</script>";
}
